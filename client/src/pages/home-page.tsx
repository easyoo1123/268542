...
export default function HomePage() {
  ...
  return (
    <MobileContainer>
      <div className="pb-20 overflow-x-hidden touch-none">
        <TopNavigation />
        
        {/* ส่วนต้อนรับผู้ใช้ */}
        <div className="bg-gradient-to-br from-primary/10 to-primary/5 overflow-hidden">
          {/* สไลด์โฆษณา */}
          <motion.div 
            initial={{ y: 10, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ duration: 0.5 }}
            className="mt-3 w-full overflow-hidden touch-none"
          >
            <AdSlider />
          </motion.div>
        </div>
